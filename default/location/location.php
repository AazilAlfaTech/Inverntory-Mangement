...
function edit_location($locationid){
    ...
    location_code='$this->',location_name='$this->location_name',location_add='$this->location_add',location_number='$this->location_number',location_email='$this->location_email'
