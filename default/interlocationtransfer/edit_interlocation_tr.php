...
$res_prod=$product1->getall_product2();

$res_loc = $loc1->get_all_location();

$res_inter_loc1 = $inter_loc_tr1->get_inter_loc_transfer_by_id($_GET['edit_intloc']);
                                    ...
                                    <form action="add_interlocation_tr.php" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input class="form-control" type="text" name="inter_loc_transfercode" id="" value="<?=$res_inter_loc1->inter_loc_transfer_code?>" disabled>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input class="form-control" type="date" name="inter_loc_transferdate" id="" value="<?=$res_inter_loc1->inter_loc_transfer_date?>" disabled>
                                            </div>
                                                ...
                                                <select class="js-example-basic-single col-sm-12 fromloc" name="inter_loc_transferfrom" id="inter_loc_transferfrom" required>
                                                    ...
                                                    <?php
                                                        foreach ($res_loc as $item)
                                                            if($item->location_id==$inter_loc_tr1->inter_loc_transfer_from)
