...
function get_prod_byloc()
{
    ...
    $stock5=new stock;
    $result_stock=$stock5->get_item_onlocation($_GET['loc_id']);
    echo json_encode($result_stock);
...
function get_productqty_prodid()
{
    include_once "../stock/stock.php";
    $stock5=new stock;
    $result_stock=$stock5->item_remaining_stock_productid($_GET['prodid'],$_GET['location']);
    echo json_encode($result_stock);
}
?>