...
function edit_sq_item()
{
    ...
    {
        $sql="UPDATE sales_quotationitem SET sq_item_price='".$_POST['sq_item_price'][$product_list]."',sq_item_qty='".$_POST['sq_item_qty'][$product_list]."',sq_item_discount='".$_POST['sq_item_discount'][$product_list]."'
        WHERE sq_item_productid='".$_POST['sq_item_productid'][$product_list]."' ";
        echo $sql;
        $this->db->query($sql);
        $product_list++;
    }
